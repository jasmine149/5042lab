...
//@EnableTransactionManagement: this tells Spring Data JPA to generate code for transaction management at runtime. //To enable Spring Data JPA, we need to create two beans: EntityManagerFactory and JpaTransactionManager.
@Configuration
...
public class JPAConfig {
    ...
    public LocalEntityManagerFactoryBean entityManagerFactory() {
        ...
        factoryBean.setPersistenceUnitName("roomDB");
        return factoryBean;
    }
